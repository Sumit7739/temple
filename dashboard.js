...
// Trend Chart (Show total amount by date, switch to week/month)
// Main function to render the Trend Chart without summing the data
const renderTrendChart = (data) => {
    ...
    // Show summary for Trend Chart without summing the data
